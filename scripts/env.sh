...
#
echo Setting Kafka/Zookeeper environment variables v1
#
echo ${DIR}
...
if [[ ${DEBUG} == "true" ]] ; then
  ...
  echo CONTROL_CENTER_KSQL_WIKIPEDIA_URL : ${CONTROL_CENTER_KSQL_WIKIPEDIA_URL}
  echo CONTROL_CENTER_KSQL_WIKIPEDIA_ADVERTISED_URL : ${CONTROL_CENTER_KSQL_WIKIPEDIA_ADVERTISED_URL}
  echo CONTROL_CENTER_KSQL_WIKIPEDIA_URL : ${CONTROL_CENTER_KSQL_WIKIPEDIA_URL}
  echo CONTROL_CENTER_KSQL_WIKIPEDIA_ADVERTISED_URL : ${CONTROL_CENTER_KSQL_WIKIPEDIA_ADVERTISED_URL}
  echo VIZ : ${VIZ}
